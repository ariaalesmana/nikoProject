...
<head>
    ...
    <title>Nikoplayzs Merch</title>
    <meta name="keywords" content="HTML5 Template">
    <meta name="description" content="Nikoplayzs Merch">
    <meta name="author" content="p-themes">
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/niko/Logo Niko Merch.jpeg">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/niko/Logo Niko Merch.jpeg">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/niko/Logo Niko Merch.jpeg">
                    ...
                    <div class="header-right">
                                                ...
                                                <div class="banner banner-overlay">
                                                    <a href="#">
                                                        ...
                                                        <div class="banner-content banner-content-bottom">
                                                            <div class="banner-title text-white">New Trends<br><span><strong>spring 2021</strong></span></div><!-- End .banner-title -->
                        ...
                        <div class="dropdown cart-dropdown">
                            <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                ...
                                <span class="cart-txt">$ 134,00</span>
                            </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="#">Nikoplayzs Merch Hoodie</a>
                                            </h4>
                                        ...
                                        <figure class="product-image-container">
                                            <a href="#" class="product-image">
                                                <img src="assets/images/niko/Hoodie.jpeg" alt="product">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="#">Nikoplayzs Merch T-Shirt</a>
                                            </h4>
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="assets/images/niko/Shirt.jpeg" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                ...
                <div class="products-container" data-layout="fitRows">
                    <div class="product-item furniture col-12 col-md-4 col-lg-3">
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="assets/images/niko/Hoodie.jpeg" alt="Product image" class="product-image">
                                </a>
                    ...
                    <div class="product-item lighting col-12 col-md-4 col-lg-3">
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="assets/images/niko/Shirt.jpeg" alt="Product image" class="product-image">
                                </a>
                            </figure><!-- End .product-media -->
                    ...
                    <div class="product-item furniture col-12 col-md-4 col-lg-3">
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="assets/images/niko/Pants.jpeg" alt="Product image" class="product-image">
                                </a>
                            </figure><!-- End .product-media -->

                            <div class="product-body">
                                <h3 class="product-title"><a href="#">Nikoplayzs Merch Pants</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $83.00
                                </div><!-- End .product-price -->
                    ...
                    <div class="product-item furniture col-12 col-md-4 col-lg-3">
                        <div class="product product-4">
                            <figure class="product-media">
                                <a href="#">
                                    <img src="assets/images/niko/Hat.jpeg" alt="Product image" class="product-image">
                                </a>
                            </figure><!-- End .product-media -->

                            <div class="product-body">
                                <h3 class="product-title"><a href="#">Nikoplayzs Merch Hat</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $32.00
                                </div><!-- End .product-price -->
